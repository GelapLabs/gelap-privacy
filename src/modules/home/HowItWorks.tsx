  ...
  return (
    <section className="relative min-h-screen bg-background overflow-hidden py-20 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full bg-gradient-radial from-primary/20 via-primary/5 to-transparent blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 w-[600px] h-[600px] rounded-full bg-gradient-radial from-secondary/15 via-secondary/3 to-transparent blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="glass rounded-3xl p-8 hover:shadow-glow transition-all duration-300 group h-full">
                  {/* Step Number */}
                  <div className="absolute -top-4 -left-4 w-12 h-12 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-bold text-lg shadow-glow">
                    {step.step}
                  </div>

                  {/* Icon */}
                  <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  ...
                  <p className="text-foreground-secondary text-center leading-relaxed">
                    {step.description}
                  </p>
                </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Hidden Layer */}
          <div className="glass rounded-3xl p-8 border-2 border-success/30">
            <h4 className="text-xl font-bold text-foreground mb-4 flex items-center gap-2">
