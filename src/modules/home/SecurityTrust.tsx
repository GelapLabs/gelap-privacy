  ...
  return (
    <section className="relative min-h-screen bg-background-secondary overflow-hidden py-20 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/3 w-[800px] h-[800px] rounded-full bg-gradient-radial from-success/10 via-success/3 to-transparent blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 w-[600px] h-[600px] rounded-full bg-gradient-radial from-primary/15 via-primary/5 to-transparent blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4">
            <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-success to-success-dark flex items-center justify-center">
        ...
        <div className="glass rounded-3xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {securityFeatures.map((feature, index) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-success/20 to-success-dark/20 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, index) => (
            ...
            >
              <div className="w-12 h-12 mx-auto rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <div className="glass rounded-3xl p-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 mb-8">
            {[
              ...
              <div
                key={index}
                className="w-32 h-32 rounded-2xl bg-background/50 flex items-center justify-center text-foreground-muted text-sm font-semibold text-center p-4 hover:bg-background/70 transition-all"
              >
                {badge}
              </div>
            ))}
